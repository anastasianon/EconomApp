...
import com.example.ecommapp.adapters.SliderAdapter;
...
//        getSupportActionBar().hide();
    ...
    //Добавление точек для перелистывания страницы
    ...
    ViewPager.OnPageChangeListener changeListener = new ViewPager.OnPageChangeListener() {
        ...
        //Появление кнопки на третьей странице после перехода на нее
        @Override
